...
// ---------- Slide Mode: turns the lesson into a keyboard/click-navigable slideshow ----------
(function () {
  let slides = [];
  let current = 0;
  ...
  function buildControls() {
    ...
    controls.innerHTML =
      '<button class="slide-prev" aria-label="Previous slide">&larr; Prev</button>' +
      '<span class="slide-pos"></span>' +
      '<button class="slide-next" aria-label="Next slide">Next &rarr;</button>';
